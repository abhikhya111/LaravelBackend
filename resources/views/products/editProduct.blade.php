      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../pages/tables/basic-table.html">
              <i class="mdi mdi-table-large menu-icon"></i>
              <span class="menu-title"><a href="/api/listProductImages" style="text-decoration:none;">Product Images</a></span>
            </a>
          </li>
        </ul>
      </nav>
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="{{$product->id}}"  name="id" placeholder="Enter Category Name"/>
                            </div>
                          </div>
                        </div>
                    </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Sub Category Id
                            </label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="{{$product->subcategory_id}}" name="name" placeholder="Enter Category Name"/>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="slug" value="{{$product->slug}}" class="form-control" placeholder="Enter Category Slug"/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="metaTitle" value="{{$product->metaTitle}}" class="form-control" placeholder="Enter Meta Title" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="metaDesc" value="{{$product->metaDesc}}"class="form-control" placeholder="Enter Meta Description" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="metaKeyword" value="{{$product->metaKeyword}}"class="form-control" placeholder="Enter Meta Keyword" />
                            </div>
                          </div>
                        </div>
