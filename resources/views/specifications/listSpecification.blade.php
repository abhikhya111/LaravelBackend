        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Product List with Specifications</h3>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td >{{$product->image}}</td>
                            <td>
                            <form action="{{ route('getSpecifications', $product->id)}}" method="GET">  
                            @csrf  
                            
                            <button class="btn btn-success" type="submit">Specifications</button>  
                          </form>                             
